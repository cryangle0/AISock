...
const refs = ref<Ref[]>([
  { bg: 'linear-gradient(135deg,#E9D5C2,#C9A98A)', url: '/static/images/ref-1.png' },
  { bg: 'linear-gradient(135deg,#CFE0D6,#8FB3A0)', url: '/static/images/ref-2.png' },
  { bg: 'linear-gradient(135deg,#E7D2D8,#C293A6)', url: '/static/images/ref-3.png' },
  { bg: 'linear-gradient(135deg,#D8D2E4,#9C8FC4)', url: '/static/images/ref-4.png' },
  { bg: 'linear-gradient(135deg,#E6D7B8,#C6A857)', url: '/static/images/ref-5.png' },
])
